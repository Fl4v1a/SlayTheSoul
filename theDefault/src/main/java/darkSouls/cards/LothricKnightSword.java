...
public class LothricKnightSword extends CustomCard {
    ...
    public static final String ID = DefaultMod.makeID(LothricKnightSword.class.getSimpleName());
