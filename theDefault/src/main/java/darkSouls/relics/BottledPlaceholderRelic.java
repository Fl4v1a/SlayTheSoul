...
import darkSouls.patches.relics.BottledPlaceholderField;
import darkSouls.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static darkSouls.DefaultMod.makeRelicOutlinePath;
import static darkSouls.DefaultMod.makeRelicPath;
